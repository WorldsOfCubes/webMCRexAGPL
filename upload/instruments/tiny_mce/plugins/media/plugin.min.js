tinymce.PluginManager.add("media", function (e, t) {
	...
	function a(e) {
		...
		return new tinymce.html.SaxParser({
			validate: !1, special: "script,noscript", start: function (e, n) {
	...
	function s(t) {
		return t.getAttribute("data-mce-object") ? a(e.serializer.serialize(t, {selection: !0})) : {}
	}
	...
	function l(e, t, n) {
		...
		var i = new tinymce.html.Writer, o = 0;
		return new tinymce.html.SaxParser({
			validate: !1, special: "script,noscript", comment: function (e) {
				i.comment(e)
			}, cdata: function (e) {
				i.cdata(e)
			}, text: function (e, t) {
				...
				switch (e) {
					...
					case"img":
					case"iframe":
						r(a, {width: t.width, height: t.height})
				}
				if (n)switch (e) {
					case"video":
						r(a, {poster: t.poster, src: ""}), t.source2 && r(a, {src: ""});
						break;
					case"iframe":
						r(a, {src: t.source1});
						break;
	...
	e.on("ResolveName", function (e) {
		...
		tinymce.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
			...
			for (var n, r, i, o, a, s, l = e.length; l--;) {
				...
				}), r.attr({style: n.attr("style")}), o = n.attributes, i = o.length; i--;) {
					var c = o[i].name;
