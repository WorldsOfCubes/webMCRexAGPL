...
(function (e, t) {
	...
	r(l, [], function () {
		...
		function o() {
			...
			c = a + (+new Date).toString(32), d = "onmouseenter"in document.documentElement, u = "onfocusin"in document.documentElement, f = {
				...
				if (n && 3 !== n.nodeType && 8 !== n.nodeType) {
					for (n[c] ? g = n[c] : (g = l++, n[c] = g, s[g] = {}), h = h || n, a = a.split(" "), y = a.length; y--;)b = a[y], x = m, C = w = !1, "DOMContentLoaded" === b && (b = "ready"), o.domLoaded && "ready" === b && "complete" == n.readyState ? p.call(h, r({type: b})) : (d || (C = f[b], C && (x = function (e) {
						var n, i;
					...
					}), v = s[g][b], v ? "ready" === b && o.domLoaded ? p({type: b}) : v.push({
						func: p, scope: h
					}) : (s[g][b] = v = [{
						func: p, scope: h
		...
		k = a.isXML = function (e) {
			...
			cacheLength: 50, createPseudo: i, match: ht, find: {}, relative: {
		...
		function s(e, n, r) {
			...
			if (e = /^((static) )?([\w.]+)(:([\w.]+))?/.exec(e), s = e[3].match(/(^|\.)(\w+)$/i)[2], a = i.createNS(e[3].replace(/\.\w+$/, ""), r), !a[s]) {
				...
				n[s] || (n[s] = function () {
				}, u = 1), a[s] = n[s], i.extend(a[s].prototype, n), e[5] && (o = i.resolve(e[5]).prototype, l = e[5].match(/\.(\w+)$/i)[1], c = a[s], a[s] = u ? function () {
			...
			root: null, props: {
				...
				if (e && n)return this.run(e, function (e) {
					...
					d(r) && null !== r && 0 !== r.length ? e.setAttribute(n, "" + r, 2) : e.removeAttribute(n, 2), a != r && o.onSetAttrib && o.onSetAttrib({
						attrElm: e, attrName: n, attrValue: r
					})
				})
		...
		function r() {
			...
			this.isDone = function (e) {
				...
				var m;
				d.push({func: i, scope: c || this}), m = function () {
					var i = a(n);
		...
		function n(e) {
			function n(e, n, r) {
				...
				for (e = t(e), o = e.length; o--;)c = [].concat(s, t(n)), a[e[o]] = {
					attributes: i(c), attributesOrder: c, children: i(r)
				}
			}
			...
			function d(e) {
				...
				if (e)for (e = t(e, ","), v["@"] && (w = v["@"].attributes, _ = v["@"].attributesOrder), n = 0, r = e.length; r > n; n++)if (s = k.exec(e[n])) {
					if (C = s[1], p = s[2], x = s[3], f = s[5], g = {}, y = [], c = {
							attributes: g, attributesOrder: y
		...
		return function (n, i) {
			...
			n = n || {}, o.schema = i = i || new e, n.fix_self_closing !== !1 && (n.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function (e) {
				...
				for (H = RegExp("<(?:(?:!--([\\w\\W]*?)-->)|(?:!\\[CDATA\\[([\\w\\W]*?)\\]\\]>)|(?:!DOCTYPE([\\w\\W]*?)>)|(?:\\?([^\\s\\/<>]+) ?([\\w\\W]*?)[?/]>)|(?:\\/([^>]+)>)|(?:([A-Za-z0-9\\-\\:\\.]+)((?:\\s+[^\"'>]+(?:(?:\"[^\"]*\")|(?:'[^']*')|[^>]*))*|\\/|\\s+)>))", "g"), M = /([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g, y = i.getShortEndedElements(), L = n.self_closing_elements || i.getSelfClosingElements(), b = i.getBoolAttrs(), x = n.validate, v = n.remove_internals, F = n.fix_self_closing, D = i.getSpecialElements(); s = H.exec(e);) {
					if (s.index > l && a.text(I(e.substr(l, s.index - l))), c = s[6])c = c.toLowerCase(), ":" === c.charAt(0) && (c = c.substr(1)), r(c); else if (c = s[7]) {
		...
		return function (i, c) {
			...
			i = i || {}, i.validate = "validate"in i ? i.validate : !0, i.root_name = i.root_name || "body", d.schema = c = c || new n, d.filterNode = function (e) {
				...
				if (a = a || {}, h = {}, m = {}, R = l(o("script,style,head,html,body,title,meta,param"), c.getBlockElements()), I = c.getNonEmptyElements(), O = c.children, T = i.validate, F = "forced_root_block"in a ? a.forced_root_block : i.forced_root_block, P = c.getWhiteSpaceElements(), A = /^[ \t\r\n]+/, H = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, D = /^[ \t\r\n]+$/, y = new r({
						validate: T, self_closing_elements: v(c.getSelfClosingElements()), cdata: function (e) {
							...
							if (i = T ? c.getElementRule(n) : {}) {
								...
								if (L && P[n] && (L = !1), (i.removeEmpty || i.paddEmpty) && C.isEmpty(I))if (i.paddEmpty)C.empty().append(new e("#text", "3")).value = "\u00a0"; else if (!C.attributes.map.name && !C.attributes.map.id)return s = C.parent, C.empty().remove(), C = s, t;
								C = C.parent
							}
						}
		...
		function e(e) {
			...
			this.getBookmark = function (r) {
				...
				function a(e) {
					var r;
					return r = n(s, e), r ? {
						position: r.position, offset: r.offset, indexes: i(r.node), inside: r.inside
					} : t
				}

				var s = e.getRng(), l = {};
				return 2 === r && (s.item ? l.start = {
					ctrl: !0, indexes: i(s.item(0))
		...
		return function (i, o) {
			...
			function l() {
				...
				L = !1, e("width", H), e("height", M), b.unbind(D, "mousemove", s), b.unbind(D, "mouseup", l), P != D && (b.unbind(P, "mousemove", s), b.unbind(P, "mouseup", l)), b.remove(w), O && "TABLE" != x.nodeName || c(x), o.fire("ObjectResized", {
					target: x, width: H, height: M
				}), o.nodeChanged()
			}

			function c(e, n, r) {
				var i, c, d, f, p;
				i = b.getPos(e, o.getBody()), S = i.x, T = i.y, p = e.getBoundingClientRect(), c = p.width || p.right - p.left, d = p.height || p.bottom - p.top, x != e && (g(), x = e, H = M = 0), f = o.fire("ObjectSelected", {target: e}), a(e) && !f.isDefaultPrevented() ? C(_, function (e, i) {
					function a(t) {
					...
					return n ? (i == n && a(r), t) : (u = b.get("mceResizeHandle" + i), u ? b.show(u) : (f = o.getBody(), u = b.add(f, "div", {
						...
						left: c * e[0] + S - u.offsetWidth / 2, top: d * e[1] + T - u.offsetHeight / 2
					}), t)
					...
					s(r.selectorChangedData, function (e, n) {
						s(a, function (r) {
							return o.is(r, n) ? (i[n] || (s(e, function (e) {
								e(!0, {node: r, selector: n, parents: a})
							}), i[n] = e), l[n] = e, !1) : t
						})
					}), s(i, function (e, t) {
						l[t] || (delete i[t], s(e, function (e) {
							e(!1, {node: n, selector: t, parents: a})
						}))
					})
		...
		return function (i) {
			...
			function h(n, r, a) {
				...
				if (g)if (a)a.nodeType ? (b = I.createRng(), b.setStartBefore(a), b.setEndAfter(a), f(T(b, m), null, !0)) : f(a, null, !0); else if (C && g.inline && !I.select("td.mce-item-selected,th.mce-item-selected").length)D("apply", n, r); else {
					...
					et(Y, function (e, i) {
						et(n, function (a) {
							return v(a, i, {}, e.similar) ? (o[i] || (et(e, function (e) {
								e(!0, {node: a, format: i, parents: n})
							}), o[i] = e), r[i] = e, !1) : t
						})
					}), et(o, function (t, i) {
						r[i] || (delete o[i], et(t, function (t) {
							t(!1, {node: e.element, format: i, parents: n})
						}))
					})
			...
			function T(n, r, s) {
				...
				function d(n, r, o) {
					...
					var l, c, u, d;
					if (3 === n.nodeType) {
						if (u = a(n, r), -1 !== u)return {container: n, offset: u};
						d = n
					}
					for (l = new e(n, I.getParent(n, V) || i.getBody()); c = l[o ? "prev" : "next"]();)if (3 === c.nodeType) {
						if (d = c, u = a(c), -1 !== u)return {container: c, offset: u}
					} else if (V(c))break;
					return d ? (r = o ? 0 : d.length, {container: d, offset: r}) : t
				}
				...
				return (r[0].inline || r[0].block_expand) && (r[0].inline && 3 == v.nodeType && 0 !== y || (v = l(!0)), r[0].inline && 3 == b.nodeType && C !== b.nodeValue.length || (b = l())), r[0].selector && r[0].expand !== K && !r[0].inline && (v = f(v, "previousSibling"), b = f(b, "nextSibling")), (r[0].block || r[0].selector) && (v = p(v, "previousSibling"), b = p(b, "nextSibling"), r[0].block && (V(v) || (v = l(!0)), V(b) || (b = l()))), 1 == v.nodeType && (y = q(v), v = v.parentNode), 1 == b.nodeType && (C = q(b) + 1, b = b.parentNode), {
					startContainer: v, startOffset: y, endContainer: b, endOffset: C
				}
			}
			...
			function D(t, n, r) {
				function o(e) {
					var t = I.create("span", {id: g, "data-mce-bogus": !0, style: y ? "color:red" : ""});
				...
				function c(e, t) {
					var n, r;
					if (e)r = F.getRng(!0), a(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), I.remove(e)) : (n = l(e), n.nodeValue.charAt(0) === $ && (n = n.deleteData(0, 1)), I.remove(e, 1)), F.setRng(r); else if (e = s(F.getStart()), !e)for (; e = I.get(g);)c(e, !1)
				}
				...
				function f() {
					...
					if (c)if (s)a = F.getBookmark(), e.collapse(!0), e = T(e, u(n), !0), e = W.split(e), m(n, r, e), F.moveToBookmark(a); else {
		...
		return i = RegExp(["<span[^>]+data-mce-bogus[^>]+>[\u200b\ufeff]+<\\/span>", "<div[^>]+data-mce-bogus[^>]+><\\/div>", '\\s?data-mce-selected="[^"]+"'].join("|"), "gi"), function (n) {
			function o() {
				return r(n.getContent({format: "raw", no_events: 1}).replace(i, ""))
			}
			...
			return n.on("init", function () {
				...
				data: c, typing: !1, beforeChange: function () {
					...
					if (e = e || {}, e.content = o(), n.fire("BeforeAddUndo", {level: e}).isDefaultPrevented())return null;
					...
					var e;
					return s.typing && (s.add(), s.typing = !1), l > 0 && (e = c[--l], n.setContent(e.content, {format: "raw"}), n.selection.moveToBookmark(e.beforeBookmark), n.fire("undo", {level: e})), e
				}, redo: function () {
					var e;
					return c.length - 1 > l && (e = c[++l], n.setContent(e.content, {format: "raw"}), n.selection.moveToBookmark(e.bookmark), n.fire("redo", {level: e})), e
				}, clear: function () {
		...
		return function (n) {
			...
			o(this, {
				execCommand: r, queryCommandState: p, queryCommandValue: h, addCommands: m
			}), m({
				"mceResetDesignMode,mceBeginUndoLevel": function () {
					...
					if (/^ | $/.test(i) && (i = o(i)), a = n.parser, s = new e({}, n.schema), b = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;</span>', f = {
							content: i, format: "html", selection: !0
						}, n.fire("BeforeSetContent", f), i = f.content, -1 == i.indexOf("{$caret}") && (i += "{$caret}"), i = i.replace(/\{\$caret\}/, b), w.isCollapsed() || n.getDoc().execCommand("Delete", !1, null), l = w.getNode(), f = {context: l.nodeName.toLowerCase()}, d = a.parse(i, f), v = d.lastChild, "mce_marker" == v.attr("id"))for (p = v, v = v.prev; v; v = v.walk(!0))if (3 == v.type || !x.isBlock(v.name)) {
		...
		return n.prototype = {
			setPath: function (e) {
				...
				var t = this, r;
				if ("./" === e)return e;
				if (e = new n(e, {base_uri: t}), "mce_host" != e.host && t.host != e.host && e.host || t.port != e.port || t.protocol != e.protocol)return e.getURI();
				...
				return e = new n(e, {base_uri: this}), e.getURI(this.host == e.host && this.protocol == e.protocol ? t : 0)
			...
			init: function (e) {
				...
				function t(e, r, i) {
					...
					for (o = 0, a = e.length; a > o; o++) {
						...
						if (s === l)i == r.length - 1 ? n.push(c) : c.items && t(c.items(), r, i + 1); else if (u.direct)return;
		...
		var o = n.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "), a = {}, s = "onmousewheel"in document, l = !1, c = e.extend({
			...
			init: function (e) {
				var r = this, o, a;
				if (r.settings = e = n.extend({}, r.Defaults, e), r._id = i.id(), r._text = r._name = "", r._width = r._height = 0, r._aria = {role: e.role}, o = e.classes)for (o = o.split(" "), o.map = {}, a = o.length; a--;)o.map[o[a]] = !0;
			...
			on: function (e, n) {
				...
				var i = this, a, s, l, c;
				if (n)for ("string" == typeof n && (n = r(n)), l = e.toLowerCase().split(" "), c = l.length; c--;)e = l[c], a = i._bindings, a || (a = i._bindings = {}), s = a[e], s || (s = a[e] = []), s.push(n), o[e] && (i._nativeEvents ? i._nativeEvents[e] = !0 : i._nativeEvents = {name: !0}, i._rendered && i.bindPendingEvents());
				return i
			},
			off: function (e, t) {
			...
			bindPendingEvents: function () {
				...
				function n(e) {
					...
					if (t !== n) {
						...
						for (i = r; a.length > i; i++)t = a[i], t.fire("mouseenter", {target: t.getEl()})
					}
				}
		...
		var o, a, s = [], l = [], c, u = e.extend({
			Mixins: [t, n], init: function (e) {
				...
				function i(e) {
					...
					e.settings.autofix && (t > (e._absY || e.layoutRect().y) ? (e._absY = e._absY || e.layoutRect().y, e.getEl().style.position = "fixed", e.layoutRect({y: 0}).repaint()) : (e.getEl().style.position = "absolute", e.layoutRect({y: e._absY}).repaint()))
				}
		...
		return function (n) {
			...
			function l() {
				var t = i();
				if (!t || "TEXTAREA" != t.nodeName && "text" != t.type)return n.onAction ? n.onAction(g) : e.fire(i(), "click", {keyboard: !0}), !0
			}
			...
			return f.on("keydown", function (e) {
				...
				r(), g = e.target.id
			}), {moveFocus: u, focusFirst: d, cancel: c}
		}
		...
		var a = e.extend({
			modal: !0, Defaults: {
				...
				e._fullscreen && (e.layoutRect(r.getWindowSize()), e.layoutRect().contentH = e.layoutRect().innerH), e._super(), n = e.layoutRect(), e.settings.title && !e._fullscreen && (i = n.headerW, i > n.w && (e.layoutRect({w: i}), o = !0)), t && (t.layoutRect({w: e.layoutRect().innerW}).recalc(), i = t.layoutRect().minW + n.deltaW, i > n.w && (e.layoutRect({w: i}), o = !0)), o && e.recalc()
			}, initLayoutRect: function () {
				...
				setTimeout(function () {
					...
					root: e, enableLeftRight: !1, enableUpDown: !1, items: t, onCancel: function () {
						e.close()
					}
		...
		return function (n) {
			...
			r.windows = i, r.open = function (t) {
				...
				return t.url = t.url || t.file, t.url && (t.width = parseInt(t.width || 320, 10), t.height = parseInt(t.height || 240, 10)), t.body && (t.items = {
					defaults: t.defaults, type: t.bodyType || "form", items: t.body
		...
		return function (s) {
			...
			function d() {
				function t(e) {
					...
					if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = I.getParent(n.startContainer, I.isBlock), e && (r = I.getNext(r, I.isBlock)), !r || !t() && n.collapsed || (i = I.create("em", {id: "__mceDel"}), D(a.grep(r.childNodes), function (e) {
							i.appendChild(e)
			...
			function N() {
				s.on("keydown", function (t) {
					...
					if (n = t.keyCode == O, !u(t) && (n || t.keyCode == P) && !e.modifierPressed(t) && (r = F.getRng(), i = r.startContainer, o = r.startOffset, c = r.collapsed, 3 == i.nodeType && i.nodeValue.length > 0 && (0 === o && !c || c && o === (n ? 0 : 1)))) {
						...
						d = s.schema.getNonEmptyElements(), t.preventDefault(), a = I.create("br", {id: "__tmp"}), i.parentNode.insertBefore(a, i), s.getDoc().execCommand(n ? "ForwardDelete" : "Delete", !1, null), i = F.getRng().startContainer, l = i.previousSibling, l && 1 == l.nodeType && !I.isBlock(l) && I.isEmpty(l) && !d[l.nodeName.toLowerCase()] && I.remove(l), I.remove("__tmp")
					}
				})
			}
		...
		var r = e.each, i = e.explode, o = {f9: 120, f10: 121, f11: 122};
		return function (e) {
			var a = this, s = {};
			e.on("keyup keypress keydown", function (e) {
				...
				return c = a, "string" == typeof a ? a = function () {
					...
					var c = {func: a, scope: l || e, desc: e.translate(n), alt: !1, ctrl: !1, shift: !1};
					r(i(t, "+"), function (e) {
						switch (e) {
							case"alt":
							case"ctrl":
			...
			render: function () {
				...
				if (n.editorManager.settings = r, n.getElement() && b.contentEditable) {
					...
					a && (n.formElement = a, r.hidden_input && !/TEXTAREA|INPUT/i.test(n.getElement().nodeName) && E.insertAfter(E.create("input", {
						...
						!n.initialized || n.destroyed || n.isHidden() || n.save({format: "raw", no_events: !0})
				...
				if (t.editorManager.add(t), n.aria_label = n.aria_label || E.getAttrib(r, "aria-label", t.getLang("aria.rich_text_area")), n.theme && ("function" != typeof n.theme ? (n.theme = n.theme.replace(/-/, ""), l = k.get(n.theme), t.theme = new l(t, k.urls[n.theme]), t.theme.init && t.theme.init(t, k.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, ""))) : t.theme = n.theme), R(n.plugins.replace(/\-/g, "").split(/[ ,]/), e), t.fire("BeforeRenderUI"), n.render_ui && t.theme && (t.orgDisplay = r.style.display, "function" != typeof n.theme ? (i = n.width || r.style.width || r.offsetWidth, o = n.height || r.style.height || r.offsetHeight, a = n.min_height || 100, f = /^[0-9\.]+(|px)$/i, f.test("" + i) && (i = Math.max(parseInt(i, 10) + (l.deltaWidth || 0), 100)), f.test("" + o) && (o = Math.max(parseInt(o, 10) + (l.deltaHeight || 0), a)), l = t.theme.renderUI({
						targetNode: r, width: i, height: o, deltaWidth: n.delta_width, deltaHeight: n.delta_height
				...
				n.inline || (t.getElement().style.visibility = t.orgVisibility), P && t.editorManager.relaxedDomain || n.content_editable || (f.open(), f.write(t.iframeHTML), f.close(), t.editorManager.relaxedDomain && (f.domain = t.editorManager.relaxedDomain)), n.content_editable && (E.addClass(o, "mce-content-body"), o.tabIndex = -1, t.contentDocument = f = n.content_document || document, t.contentWindow = n.content_window || window, t.bodyElement = o, n.content_document = n.content_window = null, n.root_name = o.nodeName.toLowerCase()), p = t.getBody(), p.disabled = !0, n.readonly || (p.contentEditable = t.getParam("content_editable_state", !0)), p.disabled = !1, t.schema = new g(n), t.dom = new e(f, {
					...
					initial: !0, format: "html"
				}), t.startContent = t.getContent({format: "raw"}), t.initialized = !0, R(t._pendingNativeEvents, function (e) {
				...
				e || (o = r.getRng(), o.item && (a = o.item(0)), n._refreshContentEditable(), i || n.getWin().focus(), (D || i) && (l = n.getBody(), l.setActive ? l.setActive() : l.focus(), i && r.normalize()), a && a.ownerDocument == s && (o = s.body.createControlRange(), o.addElement(a), o.select())), n.editorManager.activeEditor != n && ((t = n.editorManager.activeEditor) && t.fire("deactivate", {relatedTarget: n}), n.fire("activate", {relatedTarget: t})), n.editorManager.activeEditor = n
				...
				}), e.fire("NodeChange", {element: r, parents: i}))
				...
				return /^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(e) || i && i.skip_focus || o.focus(), i = T({}, i), o.fire("BeforeExecCommand", {
					...
					command: e, ui: n, value: r
				}), !0) : (o.getDoc().execCommand(e, n, r), o.fire("ExecCommand", {command: e, ui: n, value: r}), t))
				...
				return n = n || {}, n.format = n.format || "html", n.set = !0, n.content = e, n.no_events || r.fire("BeforeSetContent", n), e = n.content, P || 0 !== e.length && !/^\s+$/.test(e) ? ("raw" !== n.format && (e = new o({}, r.schema).serialize(r.parser.parse(e, {isRootContent: !0}))), n.content = L(e), r.dom.setHTML(i, n.content), n.no_events || r.fire("SetContent", n), r.settings.content_editable && document.activeElement !== r.getBody() || r.selection.normalize(), n.content) : (a = r.settings.forced_root_block, e = a && r.schema.isValidChild(i.nodeName.toLowerCase(), a.toLowerCase()) ? "<" + a + '><br data-mce-bogus="1"></' + a + ">" : '<br data-mce-bogus="1">', i.innerHTML = e, r.selection.select(i, !0), r.selection.collapse(!0), t)
			}, getContent: function (e) {
		...
		function t(n) {
			...
			function i(i) {
				...
				a.on("init", function () {
					...
					s && (a.selection.setRng(s), s = null), e != a && (e && e.fire("blur", {focusedEditor: a}), a.fire("focus", {blurredEditor: e}), a.focus(!1), n.focusedEditor = a)
				}), a.on("focusout", function () {
					s = l, window.setTimeout(function () {
						var e = n.focusedEditor;
						e != a && (s = null), o(r()) || e != a || (a.fire("blur", {focusedEditor: null}), n.focusedEditor = null, s = null)
					}, 0)
				})
			}
		...
		var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, h, m = {
			...
			remove: function (e) {
				...
				return t.activeEditor == e && (t.activeEditor = r[0]), e.destroy(), t.fire("RemoveEditor", {editor: e}), r.length || c.unbind(window, "beforeunload", h), e
			},
		...
		return i.sendRPC = function (e) {
			...
			send: function (r) {
				...
				r = o(this.settings, r), r.success = function (n, o) {
					n = e.parse(n), n === t && (n = {error: "JSON Parse error."}), n.error ? i.call(r.error_scope || r.scope, n.error, o) : a.call(r.success_scope || r.scope, n.result)
		...
		return e.extend({
			init: function (e) {
				...
				return r ? n.css(t.firstChild, {width: i.w - r.offsetWidth - 10}) : n.css(t.firstChild, {width: i.w - 10}), e._super(), e
			}, disabled: function (e) {
				var t = this;
			...
			Defaults: {
				...
				r.each(function (r) {
					...
					o && (i = new n({
						...
						autoResize: "overflow",
						defaults: {flex: 1},
						items: [{type: "label", text: o, flex: 0, forId: r._id}]
		...
		return e.extend({
			recalc: function (e) {
				...
				e.items().filter(":visible").each(function (e) {
					e.layoutRect({
						x: n.left, y: n.top, w: t.innerW - n.right - n.left, h: t.innerH - n.top - n.bottom
					}), e.recalc && e.recalc()
				})
			}
		})
		...
		n.translate = function (e) {
			...
			function n() {
				function e(r) {
					...
					if (r)return l(r, function (r) {
						var o = {text: {raw: r.title}, icon: r.icon};
				...
				var t = 0, n = [], r = [{
					title: "Headers", items: [{title: "Header 1", format: "h1"}, {title: "Header 2", format: "h2"}, {
						title: "Header 3", format: "h3"
					}, {title: "Header 4", format: "h4"}, {title: "Header 5", format: "h5"}, {
						title: "Header 6", format: "h6"
					}]
				}, {
					title: "Inline", items: [{title: "Bold", icon: "bold", format: "bold"}, {
					...
					title: "Alignment", items: [{title: "Left", icon: "alignleft", format: "alignleft"}, {
			...
			g = n(), l({
				...
				m.addButton(t, {
					tooltip: e, onPostRender: function () {
						var e = this;
				...
				m.addButton(t, {tooltip: e[0], cmd: e[1]})
			}), l({
				...
				m.addButton(t, {
					tooltip: e[0], cmd: e[1], onPostRender: function () {
						var e = this;
						m.formatter ? m.formatter.formatChanged(t, function (t) {
							e.active(t)
						}) : m.on("init", function () {
				...
				tooltip: "Undo", onPostRender: d, cmd: "undo"
			}), m.addButton("redo", {
				tooltip: "Redo", onPostRender: f, cmd: "redo"
			}), m.addMenuItem("newdocument", {
				text: "New document", shortcut: "Ctrl+N", icon: "newdocument", cmd: "mceNewDocument"
			}), m.addMenuItem("undo", {
				text: "Undo", icon: "undo", shortcut: "Ctrl+Z", onPostRender: d, cmd: "undo"
			}), m.addMenuItem("redo", {
				text: "Redo", icon: "redo", shortcut: "Ctrl+Y", onPostRender: f, cmd: "redo"
			}), m.addMenuItem("visualaid", {
				text: "Visual aids", selectable: !0, onPostRender: p, cmd: "mceToggleVisualAid"
			}), l({
				cut: ["Cut", "Cut", "Ctrl+X"],
				...
				m.addMenuItem(t, {text: e[0], icon: t, shortcut: e[2], cmd: e[1]})
				...
				return l(r, function (e) {
					n.push({
						text: {raw: e[0]}, format: e[1], textStyle: function () {
							return a(e[1])
						}
					})
				}), e.create("listbox", i.extend({text: {raw: r[0][0]}, menu: n, onclick: h}, t))
				...
				return l(r, function (e) {
					n.push({
						text: {raw: e[0]}, format: e[1], style: -1 == e[1].indexOf("dings") ? "font-family:" + e[1] : ""
					})
				}), e.create("listbox", i.extend({
					text: "Font Family", menu: n, onclick: function (e) {
				...
				return l("8pt 10pt 12pt 14pt 18pt 24pt 36pt".split(" "), function (e) {
					n.push({text: e, format: e})
				}), e.create("listbox", i.extend({
					text: "Font Sizes", menu: n, onclick: function (e) {
						e.control.settings.format && o.activeEditor.execCommand("FontSize", !1, e.control.settings.format)
					}
				}, t))
			}), m.addMenuItem("formats", {text: "Formats", menu: g})
		})
	}), r(Pt, [gt], function (e) {
		return e.extend({
			recalc: function (e) {
		...
		var i = e.extend({
			Defaults: {defaultType: "menuitem", border: 1, layout: "stack", role: "menu"}, init: function (e) {
				var t = this;
				e.autohide = !0, t._super(e), t.addClass("menu"), t.keyNav = new n({
					root: t, enableUpDown: !0, enableLeftRight: !0, leftAction: function () {
		...
		return e.extend({
			Defaults: {classes: "widget btn splitbtn", role: "splitbutton"}, repaint: function () {
				...
				return e._super(), i = t.firstChild, o = t.lastChild, n.css(i, {
					width: r.w - o.offsetWidth, height: r.h - 2
				}), n.css(o, {height: r.h - 2}), a = i.firstChild.style, a.width = a.height = "100%", a = o.firstChild.style, a.width = a.height = "100%", e
			}, activeMenu: function (e) {
				var t = this;
